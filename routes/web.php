...
use App\Http\Controllers\TipotaskController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Accesos
    Route::match(['get', 'post'], '/admtaskes', [taskController::class, 'administracion'])->name('admtaskes');
    Route::get('/taskes', [taskController::class, 'index'])->name('taskes');
    ...
    Route::post('/taskes2', [taskController::class, 'create'])->name('task.create');
    Route::post('/taskes', [taskController::class, 'update'])->name('task.update');
    ...
    Route::middleware(['checkrole:3'])->group(function () {
        ...
        Route::post('/reportes/generar/soli', [ReporteController::class, 'taskes_exel']);
        ...
        Route::middleware(['checkrole:1'])->group(function () {
            ...
            Route::get('/configuracion', [TipotaskController::class, 'index'])->name('tipotask.index');
            Route::post('/configuracion/create', [TipotaskController::class, 'create'])->name('tipotask.create');
            Route::post('/configuracion/{id}', [TipotaskController::class, 'update'])->name('tipotask.update');
            Route::post('/configuracion/delete/{id}', [TipotaskController::class, 'destroy'])->name('tipotask.delete');
            ...
            Route::get('/reportes1', function () {
                return Inertia::render('Reportes/reporte_taskes', [
